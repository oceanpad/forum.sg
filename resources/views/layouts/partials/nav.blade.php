  ...
  <div class="container">
    ...
    <div id="top-navbar-collapse" class="navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="http://localhost:8090/" class="no-pjax">资讯</a></li>
        ...
        <li class="nav-docs"><a href="http://localhost:8090/docs/home" class="no-pjax">文档</a></li>
        <li ><a href="http://localhost:8090" class="no-pjax">Laravel 入门教程</a></li>
